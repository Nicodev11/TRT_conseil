console.log("Le script registration.js est chargé !");

const city = document.getElementById("registration_form_city");
const zipCode = document.getElementById("registration_form_zip");
